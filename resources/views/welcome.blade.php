...
<body class="bg-black">
    ...
    <section id="video" class="hidden">
        <iframe width="100%" class="h-[300px] lg:h-[665px]" src="https://www.youtube.com/embed/zqE-ultsWt0"
            title="Starship | Earth to Earth" frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowfullscreen></iframe>
    </section>

    {{-- Scheduled flights section with reset filter buttons on bottom --}}
    ...
    <section class="text-white text-2xl lg:text-[60px] font-bold relative">
        <div id="cards" class="container !mt-32">
            ...
            <div class="flex gap-8 text-xs font-bold mt-20">
                <button class="group black-button border border-white rounded-full px-3 py-[6px] italic icon-button"
        ...
        <img src="{{ asset('/images/blue_gradient.png') }}"
            class="absolute right-0 top-[-200px] z-[-10] h-[500px] lg:h-[1500px] blue-gradient hidden">
    </section>
    ...
    <section class="mt-12">
        ...
        <div class="w-full flex flex-col items-center" data-aos="fade-up" data-aos-duration="500"
            data-aos-anchor-placement="top-center">
            <div class="h-[120px] w-[2px] bg-white relative z-10"></div>
            <a href="{{ route('about') }}">
                <button class="black-button py-2 px-6 uppercase border border-whiteo mt-10 w-fit text-white">About
                    us</button>
            </a>
        </div>
    </section>
